...
import { u as useChannelContext, i as isDisabledBecauseFrozen, a as isDisabledBecauseMuted, c as compareMessagesForGrouping, b as isAboutSame, d as isOperator, M as MARK_AS_READ, C as ChannelProvider } from './ChannelProvider-477ebebb.js';
...
import { i as isSameDay } from './index-85f5245b.js';
...
import { g as getClassName, a as isSentMessage, b as getUIKitMessageTypes, c as getSenderName, d as isTextMessage, e as isS3ImageMessage, f as isOGMessage, h as getUIKitMessageType, j as isThumbnailMessage } from './index-5ddc9ee9.js';
import { M as MAX_USER_MENTION_COUNT, a as MAX_USER_SUGGESTION_COUNT } from './const-b6b0314e.js';
...
import { u as useLocalization, a as LocalizationContext } from './LocalizationContext-6b2a3bfd.js';
...
import { M as MessageInputKeys } from './const-cb851d82.js';
...
function MessageContent(_a) {
  ...
  var externalBucketUrl = useContext(FileInputContext).externalBucketUrl;
  ...
  ((_e = (_d = channel === null || channel === void 0 ? void 0 : channel.members) === null || _d === void 0 ? void 0 : _d.find(function (member) {
    ...
    message: message,
    channel: channel
  }))), isTextMessage(message, externalBucketUrl) && /*#__PURE__*/React__default.createElement(TextMessageItemBody, {
...
//# sourceMappingURL=index-4dac8185.js.map
