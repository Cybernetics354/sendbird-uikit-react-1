...
var topics = require('./topics-9033c412.js');
var index = require('./index-442b2a43.js');
var _rollupPluginBabelHelpers = require('./_rollupPluginBabelHelpers-95f9644b.js');
var compareIds = require('./compareIds-3c8f7012.js');
var _const = require('./const-7bb52067.js');
var groupChannel = require('./groupChannel-506f10a9.js');
var uuid = require('./uuid-35ad849a.js');
var __bundleBa710a09 = require('./__bundle-ba710a09-aa384520.js');
...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case SEND_MESSAGEGE_SUCESS:
      {
        const newMessages = state.allMessages.map(m => compareIds.compareIds(m.reqId, action.payload.reqId) ? action.payload : m);
  ...
  React.useEffect(() => {
    ...
    if (currentGroupChannel && currentGroupChannel !== null && currentGroupChannel !== void 0 && currentGroupChannel.getMessagesByTimestamp) {
      ...
      if (replyType && replyType === 'QUOTE_REPLY') {
        ...
        messageListParams.replyType = __bundleBa710a09.ue.ONLY_REPLY_TO_CHANNEL;
      }
    ...
    return function () {
      ...
      if (wasOffline && (currentGroupChannel === null || currentGroupChannel === void 0 ? void 0 : currentGroupChannel.url)) {
        ...
        if (replyType && replyType === 'QUOTE_REPLY') {
          ...
          messageListParams_1.replyType = __bundleBa710a09.ue.ONLY_REPLY_TO_CHANNEL;
        }
...
//# sourceMappingURL=ChannelProvider-c6834144.js.map
