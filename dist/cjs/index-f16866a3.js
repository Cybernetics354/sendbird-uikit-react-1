...
var index$2 = require('./index-358d0bff.js');
...
function MessageContent(_a) {
  ...
  var externalBucketUrl = React.useContext(FileInputContext).externalBucketUrl;
  ...
  ((_e = (_d = channel === null || channel === void 0 ? void 0 : channel.members) === null || _d === void 0 ? void 0 : _d.find(function (member) {
    ...
    message: message,
    channel: channel
  }))), index.isTextMessage(message, externalBucketUrl) && /*#__PURE__*/React__default["default"].createElement(ui_TextMessageItemBody, {
...
//# sourceMappingURL=index-f16866a3.js.map
