...
var index = require('./index-e992811c.js');
...
var openChannel = require('./openChannel-3debd87b.js');
    ...
    if (currentOpenChannel && currentOpenChannel.url && ((_a = sdk === null || sdk === void 0 ? void 0 : sdk.openChannel) === null || _a === void 0 ? void 0 : _a.addOpenChannelHandler)) {
      ...
      var channelHandlerParams = {
        ...
        onChannelDeleted: function (channelUrl, channelType) {
          if (channelType === __bundleBa710a09.ne.OPEN && (currentOpenChannel === null || currentOpenChannel === void 0 ? void 0 : currentOpenChannel.url) === channelUrl) {
            messagesDispatcher({
...
//# sourceMappingURL=OpenChannelProvider-e0b3c618.js.map
