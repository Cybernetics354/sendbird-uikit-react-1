...
function useGetSearchedMessages(_a, _b) {
  ...
  React.useEffect(function () {
    ...
    if (sdk && channelUrl && sdk.createMessageSearchQuery && currentChannel) {
      if (requestString) {
        var inputSearchMessageQueryObject = tslib_es6.__assign(tslib_es6.__assign({}, messageSearchQuery), {
          order: 'ts',
        ...
        var createdQuery_1 = sdk.createMessageSearchQuery(inputSearchMessageQueryObject);
        createdQuery_1.next().then(function (messages) {
